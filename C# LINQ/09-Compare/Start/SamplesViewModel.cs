  ...
  public class SamplesViewModel : ViewModelBase
  {
    ...
    public List<Product> ExceptByQuery()
    {
      ...
      List<string> colors = new() { "Red", "Black" };
            ...
            // Write Query Syntax Here
            list = (from prod in products
                    select prod).ExceptBy(colors, prod => prod.Color).ToList();
    ...
    public List<Product> ExceptByMethod()
    {
      ...
      List<string> colors = new() { "Red", "Black" };
            ...
            // Write Method Syntax Here
            list = products.ExceptBy(colors, prod => prod.Color).ToList();
    ...
    public List<Product> ExceptByProductSalesQuery()
    {
      ...
      List<SalesOrder> sales = SalesOrderRepository.GetAll();
            ...
            list = (from prod in products
                    select prod).
                    ExceptBy<Product, int>(from sale in  sales
                                           select sale.ProductID, prod => prod.ProductID).ToList();
    ...
    public List<Product> ExceptByProductSalesMethod()
    {
      ...
      List<SalesOrder> sales = SalesOrderRepository.GetAll();
            ...
            list = products.ExceptBy<Product, int>
                      (sales.Select(sale => sale.ProductID), prod => prod.ProductID).ToList();
    ...
    public List<int> IntersectProductSalesQuery()
    {
      ...
      // Write Query Syntax Here
      list = (from prod in products
              select prod.ProductID).Intersect(from sale in sales
                                     select sale.ProductID).ToList();
    ...
    public List<Product> IntersectUsingComparerQuery()
    {
      ...
      // Write Query Syntax Here
      list = (from l in list1
              select l).Intersect(list2, pc).ToList();
    ...
    public List<Product> IntersectByQuery()
    {
      ...
      // Write Query Syntax Here
      list = (from prod in products
              select prod).IntersectBy(colors, prod => prod.Color).ToList();
    ...
    public List<Product> IntersectByProductSalesQuery()
    {
      ...
      // Write Query Syntax Here
      list = (from prod in products
              select prod).IntersectBy<Product, int>(
    ...
    public List<Product> IntersectByProductSalesMethod()
    {
      ...
      // Write Method Syntax Here
      list = products.IntersectBy<Product, int>(sales.Select(sale => sale.ProductID), prod => prod.ProductID).ToList();
