...
namespace LINQSamples
{
  public class SamplesViewModel : ViewModelBase
  {
    ...
    public int CountFilteredQuery()
    {
      ...
      //value = (from prod in products
      //         select prod).Where(prod => prod.Color=="Red").Count();
    ...
    public Product MinByQuery()
    {
      ...
      product = (from prod in products
                 select prod).MinBy(prod => prod.ListPrice);
    ...
    public Product MaxByQuery()
    {
      ...
      List<Product> products = ProductRepository.GetAll();
            ...
            // Write Query Syntax Here
            product = (from prod in products
                       select prod).MaxBy(prod => prod.ListPrice);
    ...
    public decimal AggregateCustomQuery()
    {
      ...
      List<SalesOrder> sales = SalesOrderRepository.GetAll();
            ...
            value = (from sale in sales
                     select sale).Aggregate(0M, (Total, sale) =>
                     Total += (sale.OrderQty * sale.UnitPrice));
    ...
    public decimal AggregateCustomMethod()
    {
      ...
      List<SalesOrder> sales = SalesOrderRepository.GetAll();
            ...
            // Write Method Syntax Here
            value = sales.Aggregate(0M, (Total, sale) =>
                     Total += (sale.OrderQty * sale.UnitPrice));
    ...
    public List<ProductStats> AggregateUsingGroupByQuery()
    {
      ...
      list = (from prod in products
              ...
              select new ProductStats
              {
                  ...
                  MaxListPrice = sizeGroup.Min(s => s.ListPrice),
                  MinListPrice = sizeGroup.Max(s => s.ListPrice),
