  ...
  public class SamplesViewModel : ViewModelBase
  {
    ...
    public List<IGrouping<string, Product>> GroupByMethod()
    {
      ...
      List<Product> products = ProductRepository.GetAll();
            ...
            list = products.OrderBy(prod => prod.Size).GroupBy(prod => prod.Size).ToList();
    ...
    public List<SaleProducts> GroupBySubQueryMethod()
    {
      ...
      List<SalesOrder> sales = SalesOrderRepository.GetAll();
            ...
            // Write Method Syntax Here
            list = sales.OrderBy(sale => sale.SalesOrderID).
                      GroupBy(sale => sale.SalesOrderID).
                      Select(newSales => new SaleProducts
                      {
                          SalesOrderID = newSales.Key,
                          Products = products.OrderBy(prod => prod.ProductID)
                          .Join(newSales, prod => prod.ProductID, sale => sale.ProductID,
    ...
    public List<string> GroupByDistinctMethod()
    {
      ...
      List<Product> products = ProductRepository.GetAll();
            ...
            // Write Method Syntax Here
            list = products.GroupBy(prod => prod.Color).
