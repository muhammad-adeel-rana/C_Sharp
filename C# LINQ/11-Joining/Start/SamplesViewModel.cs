  ...
  public class SamplesViewModel : ViewModelBase
  {
      ...
      List<SalesOrder> sales = SalesOrderRepository.GetAll();
            ...
            list = (from prod in products
                    ...
                    select new ProductOrder
                    {
                        ...
                        LineTotal = sale.LineTotal}).OrderBy(prod => prod.Name).ToList();
    ...
    public List<ProductOrder> InnerJoinTwoFieldsMethod()
    {
      ...
      List<SalesOrder> sales = SalesOrderRepository.GetAll();
            ...
            // Write Method Syntax Here
            list = products.Join(sales, prod => new { prod.ProductID, Qty = (short)6 },
    ...
    public List<ProductSales> JoinIntoMethod()
    {
      ...
      List<SalesOrder> sales = SalesOrderRepository.GetAll();
            ...
            // Write Method Syntax Here
            list = products.OrderBy(prod => prod.ProductID).GroupJoin(sales, prod => prod.ProductID,
                sale => sale.ProductID, (prod, newSales) => new ProductSales
                    {
                        Product = prod,
                        Sales = newSales.OrderBy(s => s.SalesOrderID).ToList()
                    }).ToList();
    ...
    public List<ProductOrder> LeftOuterJoinMethod()
    {
      ...
      List<SalesOrder> sales = SalesOrderRepository.GetAll();
            ...
            // Write Method Syntax Here
            list = products.SelectMany(prod => 
            sales.Where(s => s.ProductID == prod.ProductID).DefaultIfEmpty(),
            (prod, sale) =>  new ProductOrder
                    {
                        ProductID = prod.ProductID,
                        Name = prod.Name,
