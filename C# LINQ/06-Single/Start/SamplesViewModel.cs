...
namespace LINQSamples
{
  public class SamplesViewModel : ViewModelBase
  {
    ...
    public Product FirstQuery()
    {
      ...
      //value = (from product in products select product)
    ...
    public Product FirstOrDefaultWithDefaultMethod()
    {
      ...
      Product value = null;
            ...
            // Write Method Syntax Here
            value = products.FirstOrDefault(prod => prod.Color == "purple",
                            new Product { ProductID = -1, Name = "Not Found" });
            return value;
    }
    #endregion
    ...
    public Product SingleQuery()
    {
      ...
      Product value = null;
            ...
            //value = (from prod in products select prod).Single(prod => prod.Name.StartsWith("S"));
            // Test the exception handling for the list is null
            value = (from prod in products select prod).Single(prod => prod.Name.StartsWith("B"));
            return value;
    }
    #endregion
    ...
    public Product SingleOrDefaultQuery()
    {
      ...
      Product value = null;
            ...
            // Test the exception handling for finding multiple values
            //value = (from prod in products select prod).
            //    SingleOrDefault(prod => prod.Name.StartsWith("S"));

            // Test the exception handling for the list is empty
            //value = (from prod in products select prod).
            //    SingleOrDefault(prod => prod.Name.StartsWith("B"));
