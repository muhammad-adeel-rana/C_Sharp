namespace LINQSamples
{
  public class SamplesViewModel : ViewModelBase
  {
    ...
    public List<int> UnionIntegersQuery()
    {
      ...
      list = (from num in list1 select num).Union(list2).ToList();
    ...
    public List<Product> UnionQuery()
    {
      ...
      // Write Query Syntax Here
      list = (from l in list1 select l).Union(list2, pc).ToList();
    ...
    public List<Product> UnionByQuery()
    {
      ...
      List<Product> list2 = ProductRepository.GetAll();
            ...
            // Write Query Syntax Here
            list = (from l in list1 select l).UnionBy(list2, l => l.Color).ToList();
    ...
    public List<Product> UnionByMethod()
    {
      ...
      // Write Method Syntax Here
      list = list1.UnionBy(list2,l => l.Color).ToList();
    ...
    public List<int> ConcatIntegersQuery()
    {
      ...
      // Write Query Syntax Here
      list = (from l in list1 select l).Concat(list2).ToList();
