  ...
  public class SamplesViewModel : ViewModelBase {
    ...
    public List<Product> ForEachSubQueryMethod() {
      ...
      List<SalesOrder> sales = SalesOrderRepository.GetAll();
            ...
            // Write Method Syntax Here
            products.ForEach(prod => prod.TotalSales = sales.Where(sale => sale.ProductID == prod.ProductID)
    ...
    public List<Product> ForEachQueryCallingMethodQuery() {
      ...
      list = list.Where(prod => prod.TotalSales > 0).ToList();
    ...
    public List<Product> ForEachQueryCallingMethod() {
      ...
      List<SalesOrder> sales = SalesOrderRepository.GetAll();
            ...
            products = products.Where(prod => prod.TotalSales > 0).ToList();
