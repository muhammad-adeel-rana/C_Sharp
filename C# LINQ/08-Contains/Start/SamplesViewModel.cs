...
namespace LINQSamples
{
  public class SamplesViewModel : ViewModelBase
  {
    ...
    public bool AllSalesMethod()
    {
      ...
      // Write Method Syntax Here
      value = sales.All(sales => sales.OrderQty >= 1);
    ...
    public bool AnyQuery()
    {
      ...
      // Write Query Syntax Here
      value = (from sale in sales
               select sale).Any(sale => sale.LineTotal > 10000);
    ...
    public bool ContainsComparerQuery()
    {
      ...
      bool value = false;
            ...
            value = (from p in products
                     select p).Contains(new Product { ProductID = 744 }, pc);
